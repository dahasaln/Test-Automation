    ...
    def test_get_registration_valid(self, browser):
        ...
        with open(r"../pages/Settings.py", 'r', encoding='utf8') as file:
            ...
            for line in file.readlines():
                ...
                elif 'valid_firstname_reg' in line:
                    lines.append(f"valid_firstname_reg = '{fake_firstname}'\n")
                elif 'valid_lastname_reg' in line:
                    lines.append(f"valid_lastname_reg = '{fake_lastname}'\n")
                else:
                    lines.append(line)
